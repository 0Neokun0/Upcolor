...
/* card style 1 現在のカードCSS */
.profile-card-1 {
    background-color: #FEFEFE;
    border-radius: 10px;
    box-shadow: 0px 0px 25px rgba(63,218,216,1) 40%;
    background-image: url(../../profile_images/no-photo.jpg);
...
.profile-card-1 .profile-img img {
    ...
    box-shadow: 0px 0px 10px rgba(63,218,216,1) 40%;
}
...
.profile-card-1:hover {
    box-shadow: 0px 0px 50px rgba(63,218,216,1) 40%;
}
...
/* card style 1 現在のカードCSS 終わり*/

/* card style 2 現在のカードCSS */
